...
### 3.1 Etapa 1: Análise de Domínio e Contextos Delimitados (DDD)
...
#### 3.1.4 Conexão com a Próxima Etapa e Métricas:
...
### 3.2 Etapa 2: Análise de Dependências Estáticas
...
#### 3.2.4 Conexão com a Próxima Etapa e Métricas: Os limites refinados estruturalmente e as métricas calculadas servem de input para a Análise Dinâmica. A análise estática foca em melhorar LCOM4, CBO, Ca/Ce e identificar violações estruturais, complementando a visão de negócio da Etapa 1.

### 3.3 Etapa 3: Análise Dinâmica (Comportamental)
...
#### 3.3.4 Conexão com a Próxima Etapa e Métricas:
...
### 3.4 Etapa 4: Análise da Evolução do Código (Histórico de Versões)
...
#### 3.4.4 Conexão com a Próxima Etapa e Métricas:
...
### 3.5. Etapa 5: Integração das Análises, Validação Humana e Refinamento Iterativo
...
#### 3.5.4 Conexão com a Próxima Etapa e Métricas:

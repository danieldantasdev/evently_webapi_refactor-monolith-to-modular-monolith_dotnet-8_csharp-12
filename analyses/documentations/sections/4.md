...
### 4.1 Análise de Domínio e Contextos Delimitados (DDD)
...
### 4.2 Análise de Responsabilidades e Funcionalidades
...
### 4.3 Análise de Dependências Estáticas (Código)
...
### 4.4 Análise Dinâmica (Comportamento em Execução)
...
### 4.5 Análise da Evolução do Código (Histórico de Versões)
...
### 4.6 Integração das Análises e Abordagem Híbrida
...
#### 4.2.4 Conexão com a Próxima Etapa e Métricas: Os limites refinados estruturalmente e as métricas calculadas servem de input para a Análise Dinâmica. A análise estática foca em melhorar LCOM4, CBO, Ca/Ce e identificar violações estruturais, complementando a visão de negócio da Etapa 1.
